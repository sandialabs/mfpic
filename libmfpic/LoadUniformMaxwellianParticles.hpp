...
/**
 * @brief Load a requested number of particles distributed uniformly in space and Maxwellian in velocity space.
 *
...
ParticleContainer loadUniformMaxwellianParticles(
  Species species,
  ...
  for (int i = 0; i < num_particles; i++) {
    ...
    double pdf_value = euler::evaluateMaxwellian(primitive_state,velocity,species,mesh->SpaceDimension());
