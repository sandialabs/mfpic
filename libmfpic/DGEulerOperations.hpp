...
public:
  ...
  */
  ...
  /**
  * @brief Evaluates the particle distribution function for the low fidelity state at position and velocity. The PDF corresponds to a Maxwellian in velocity-space and a Uniform distribution in physical space
  *
  * @param current_state State including dofs and species list 
