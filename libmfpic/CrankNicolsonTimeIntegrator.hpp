...
public:
  /**
   * @brief Advance the low fidelity states one timestep using the CrankNicolson algorithm for the plasma oscillation and the
   *  forward euler algorithm for the fluid convection.
